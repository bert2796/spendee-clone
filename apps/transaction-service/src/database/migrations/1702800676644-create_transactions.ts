...
export class CreateTransactions1702800676644 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "transactions" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "walletId" integer NOT NULL, "categoryId" integer NOT NULL, "amount" bigint NOT NULL, "type" "public"."transactions_type_enum" NOT NULL, "date" date NOT NULL, "note" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_TRANSACTION" ON "transactions" ("userId", "walletId", "date", "type") `);
    }
